...
{
    return __builtin_popcount(x);    // # of bits set
}
...
int  main()
{
    ...
    while(t--)
    {
        ...
        else
        {
            ...
            {
                if(s[s.size()-1]=='L' && ss[ss.size()-1]=='S')
                {
                    cout<<'>'<<endl;
                }
                else if(s[s.size()-1]=='S' && ss[ss.size()-1]=='L')
                {
                    cout<<'<'<<endl;
                }
                else if(s>ss) cout<<'>'<<endl;
                else if(ss!="M")cout<<'<'<<endl;
                else cout<<'>'<<endl;
            }
            else
            {
